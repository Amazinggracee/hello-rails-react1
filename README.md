...
# 📖 hello-rails-react1<a name="about-project"></a>
...
```sh
  git clone https://github.com/Amazinggracee/hello-rails-react1.git
```
...
Feel free to check the [issues page](https://github.com/Amazinggracee/Hello-React-Rails1/issues. )
